...
class QueryTokenizer():
    def __init__(self, query_maxlen):
        ...
        print(self.cls_token_id,self.sep_token_id,self.mask_token_id)
    ...
    def tokenize(self, batch_text, add_special_tokens=False):
        ...
        tokens = [prefix + lst + suffix + [self.mask_token] * (self.query_maxlen - (len(lst)+2)) for lst in tokens]
    ...
    def encode(self, batch_text, add_special_tokens=False):
        ...
        ids = [prefix + lst + suffix + [self.mask_token_id] * (self.query_maxlen - (len(lst)+2)) for lst in ids]
