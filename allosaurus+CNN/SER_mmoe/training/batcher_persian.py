...
class PretrainBatcher_pe():
    ...
    def __next__(self):
        cls_label_map = {"W":0, "A":1, "F":2, "S":3,"H":4,"N":5}
        audio_filenames = []
        labels = []
        line_idx = 0
    ...
    def collate(self, audio_filenames,labels):
        ...
        return self.tensorize_triples(self.args,"pe",audio_filenames, labels, self.bsize // self.accumsteps)
