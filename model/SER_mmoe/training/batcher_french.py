...
from SER_mmoe.training.utils import  tensorize_triples

class PretrainBatcher_fr():
    def __init__(self, args, path, rank=0, nranks=1):
        self.args = args
        self.rank, self.nranks = rank, nranks
        self.bsize, self.accumsteps = 256, args.accumsteps
    ...
    def __next__(self):
        cls_label_map = {"C":0, "D":1, "J":2, "N":3,"P":4,"S":5,"T":6}
        audio_filenames = []
        labels = []
        line_idx = 0
    ...
    def collate(self, audio_filenames,labels):
        ...
        return self.tensorize_triples(self.args,"fr",audio_filenames, labels, self.bsize // self.accumsteps)
